		...
		<aside id="colorlib-aside" role="complementary" class="js-fullheight text-center">
			...
			<nav id="colorlib-main-menu" role="navigation">
				<ul>
					...
					<li class="colorlib-active"><a href="services.jsp">My Services</a></li>
	        ...
	        <div class="row">
	          <div class="col-md-4 d-flex align-self-stretch ftco-animate">
	            <div class="media block-6 services py-4 d-block">
				  ...
				  <a href="nearStamp.jsp" target="_self">
	              <div class="media-body p-2 mt-2">
	                <h3 class="heading mb-3">Find Stamp</h3>
	          ...
	          <div class="col-md-4 d-flex align-self-stretch ftco-animate">
	            <div class="media block-6 services py-4 d-block">
				  ...
				  <a href="keywordStamp.jsp">
	              <div class="media-body p-2 mt-2">
	                <h3 class="heading mb-3">KeyWord Stamp</h3>
	          ...
	          <div class="col-md-4 d-flex align-self-stretch ftco-animate">
	            <div class="media block-6 services py-4 d-block">
	              ...
	              <a href="mypage.jsp">
	              <div class="media-body p-2 mt-2">
	                <h3 class="heading mb-3">My Page</h3>
	                <p>개인정보를 변경하세요.</p>
	              </div>
	              </a>
	            </div>      
              ...
              <div class="media-body p-2 mt-2">
                <h3 class="heading mb-3">About Us</h3>
                <p>저희에 대해 궁금하신가요?</p>
              </div>
            </div>
          </div>
