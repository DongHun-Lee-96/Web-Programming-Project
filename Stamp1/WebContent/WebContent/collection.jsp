  ...
  <body>
	...
	<div id="colorlib-page">
		...
		<aside id="colorlib-aside" role="complementary" class="js-fullheight text-center">
			<h1 id="colorlib-logo"><a href="home.jsp"><span class="img" style="background-image: url(images/author.jpg);"></span>STAMP</a></h1>
			<nav id="colorlib-main-menu" role="navigation">
				<ul>
					<li><a href="home.jsp">Home</a></li>
					<li class="colorlib-active"><a href="collection.jsp">My Stamp</a></li>
		...
		<div id="colorlib-main">
			<section class="ftco-section ftco-bread">
	          ...
	          <div class="col-md-8 ftco-animate">
	            <p class="breadcrumbs"><span class="mr-2"><a href="home.jsp">Home</a></span> <span>Collection</span></p>
	            <h1 class="bread">My Stamp</h1>
	          </div>
	        </div>
				</div>
			</section>
			<section class="ftco-section-3">
				<div class="form-group" style="float:right;">
                         <a href="stamping.html">
                         <input type="submit" value="추가 하기" class="btn btn-primary py-2 px-5">
                         </a>
                         <input type="submit" value="삭제 하기" class="btn btn-primary py-2 px-5">
                      </div>
				<div class="photograhy" style="clear:right;">
					<div class="row">
