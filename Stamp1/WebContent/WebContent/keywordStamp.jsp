		...
		<div id="colorlib-main">
			<section class="ftco-section ftco-bread">
	          ...
	          <div class="col-md-8 ftco-animate">
	            <p class="breadcrumbs"><span class="mr-2"><a href="home.jsp">Home</a></span> <span>Blog</span></p>
	    				...
	    				<div class="row">
			    			<div class="col-md-12">
			    				<div class="blog-entry ftco-animate d-md-flex">
										<a href="single.jsp" class="img img-2" style="background-image: url(images/image_1.jpg);"></a>
										<div class="text text-2 p-4">
				              <h3 class="mb-2"><a href="single.jsp">The Photography Technique</a></h3>
				              <div class="meta-wrap">
												<p class="meta">
				              		<span>Dec 14, 2018</span>
				              		<span><a href="single.jsp">Photography</a></span>
				              		<span>5 Comment</span>
				              	</p>
			              	</div>
			    			...
			    			<div class="col-md-12">
			    				<div class="blog-entry ftco-animate d-md-flex">
										<a href="single.jsp" class="img img-2" style="background-image: url(images/image_2.jpg);"></a>
										<div class="text text-2 p-4">
				              <h3 class="mb-2"><a href="single.jsp">The Photography Technique</a></h3>
				              <div class="meta-wrap">
												<p class="meta">
			    			...
			    			<div class="col-md-12">
			    				<div class="blog-entry ftco-animate d-md-flex">
										<a href="single.jsp" class="img img-2" style="background-image: url(images/image_3.jpg);"></a>
										<div class="text text-2 p-4">
				              <h3 class="mb-2"><a href="single.jsp">The Photography Technique</a></h3>
				              <div class="meta-wrap">
												<p class="meta">
			    			...
			    			<div class="col-md-12">
			    				<div class="blog-entry ftco-animate d-md-flex">
										<a href="single.jsp" class="img img-2" style="background-image: url(images/image_4.jpg);"></a>
										<div class="text text-2 p-4">
				              <h3 class="mb-2"><a href="single.jsp">The Photography Technique</a></h3>
				              <div class="meta-wrap">
												<p class="meta">
			    			...
			    			<div class="col-md-12">
			    				<div class="blog-entry ftco-animate d-md-flex">
										<a href="single.jsp" class="img img-2" style="background-image: url(images/image_5.jpg);"></a>
										<div class="text text-2 p-4">
				              <h3 class="mb-2"><a href="single.jsp">The Photography Technique</a></h3>
				              <div class="meta-wrap">
												<p class="meta">
			    			...
			    			<div class="col-md-12">
			    				<div class="blog-entry ftco-animate d-md-flex">
										<a href="single.jsp" class="img img-2" style="background-image: url(images/image_6.jpg);"></a>
										<div class="text text-2 p-4">
				              <h3 class="mb-2"><a href="single.jsp">The Photography Technique</a></h3>
				              <div class="meta-wrap">
												<p class="meta">
			    			...
			    			<div class="col-md-12">
			    				<div class="blog-entry ftco-animate d-md-flex">
										<a href="single.jsp" class="img img-2" style="background-image: url(images/image_7.jpg);"></a>
										<div class="text text-2 p-4">
				              <h3 class="mb-2"><a href="single.jsp">The Photography Technique</a></h3>
				              <div class="meta-wrap">
												<p class="meta">
			    			...
			    			<div class="col-md-12">
			    				<div class="blog-entry ftco-animate d-md-flex">
										<a href="single.jsp" class="img img-2" style="background-image: url(images/image_8.jpg);"></a>
										<div class="text text-2 p-4">
				              <h3 class="mb-2"><a href="single.jsp">The Photography Technique</a></h3>
				              <div class="meta-wrap">
												<p class="meta">
	          ...
	          <div class="col-md">
	             <div class="ftco-footer-widget mb-4">
	              ...
	              <ul class="list-unstyled categories">
	              	...
	              	<li><a href="#">Decob14 2018 <span>(212)</span></a></li>
